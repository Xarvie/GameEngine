...
#include "application.h" // 包含Application以获取Resolution定义
    ...
    namespace sample {
        ...
        namespace internal {
            ...
            public:
                ...
                // ====================== 新增方法 ======================
                // 允许Application类设置相机的分辨率信息
                void set_resolution(const Resolution& _resolution) { resolution_ = _resolution; }
                // ======================================================
            ...
            private:
                ...
                // ====================== 新增成员变量 ======================
                Resolution resolution_; // 存储当前窗口分辨率
                // ========================================================
            };
        } // namespace internal
    } // namespace sample
